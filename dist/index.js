...
var newServer = new Hapi.Server({
    port: configs_1.default.API.PORT,
    host: configs_1.default.API.HOST,
    routes: {
        cors: true
    }
});
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                server.auth.strategy('jwt', 'jwt', {
                    key: Constants_1.default.TOKEN_SECRET_KEY,
                    validate: common_1.validateUserId(userRepo),
                    verifyOptions: { algorithms: ['HS256'] }
                });
                server.auth.default('jwt');
                routes = routeResolver_1.default(connection);
