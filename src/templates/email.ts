                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                          Hi ${fullName}, We are Hotello
                        </p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                          This is the active code for finish register. This code will be expired in 10 minutes
                        </p>
                        <table
                          border="0"
                          cellpadding="0"
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <tbody>
                                    <tr>
                                     <h1 style="text-align: 'center'; font-size: 2rem">${otp}</h1>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                          If you have issue when use this active code, please click resend code in the app.
                        </p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                ...
                <tr>
                  ...
                  >
                    <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;"
                      >Viet Nam, 119 2F Quang Trung, Hoan Kiem, Ha Noi</span
                    >
                    <br />
